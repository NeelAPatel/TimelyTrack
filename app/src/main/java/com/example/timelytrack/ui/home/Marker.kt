...
internal fun rememberMarker(
  ...
  val labelBackground =
    rememberShapeComponent(
      fill = Fill(MaterialTheme.colorScheme.surfaceBright.toArgb()),
  ...
  val indicatorFrontComponent =
    rememberShapeComponent(fill = Fill(MaterialTheme.colorScheme.surface.toArgb()), CorneredShape.Pill)
      ...
      DefaultCartesianMarker(
        ...
        indicator =
          if (showIndicator) {
            { color ->
              LayeredComponent(
                rear = ShapeComponent(Fill(ColorUtils.setAlphaComponent(color, 38)), CorneredShape.Pill),
                front =
                  LayeredComponent(
                    rear =
                      ShapeComponent(
